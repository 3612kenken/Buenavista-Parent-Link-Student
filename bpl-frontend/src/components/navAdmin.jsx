    ...
    <img src="/assets/bpl.png" alt="" className="logo logo-lg" />
            ...
            <ul className="pc-navbar">
                ...
                <a href="/dashboard/index.html" className="pc-link"
                    ><span className="pc-micon"><i className="ti ti-dashboard"></i></span><span className="pc-mtext">Student Performance</span></a
                >
                </li>
                ...
                <li className="pc-item">
                <a className="pc-link" target="_blank" href="/pages/login-v3.html">
                    <span className="pc-micon"><i className="ti ti-list"></i></span>
                    <span className="pc-mtext">Attendance</span>
                </a>
                </li>
                <li className="pc-item">
                <a href="/pages/register-v3.html" target="_blank" className="pc-link">
                    <span className="pc-micon"><i className="ti ti-trending-up"></i></span>
                 ...
                 <li className="pc-item">
                <a href="/pages/register-v3.html" target="_blank" className="pc-link">
                    <span className="pc-micon"><i className="ti ti-math-symbols"></i></span>
                ...
                <a href="/other/sample-page.html" className="pc-link">
                    <span className="pc-micon"><i className="ti ti-stack"></i></span>
